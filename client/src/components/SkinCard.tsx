...
// Opções de tempo para o filtro
const TIME_RANGES = [
  { label: '7D', days: 7 },
  { label: '1M', days: 30 },
  { label: '3M', days: 90 },
  { label: 'TD', days: 'all' }, // TD = Tudo (Desde o início)
];
...
export function SkinCard({ name, prices, ids, priceHistory, imageUrl, currency, rate, onRemove, historySource: initialSource }: SkinCardProps) {
  ...
  // --- LÓGICA PRINCIPAL: Filtra datas e Converte Moeda ---
  ...
  // Cálculos de Tendência (Baseado no displayHistory filtrado)
  ...
  // Busca histórico manualmente ao clicar nos botões de fonte
  ...
  // Componente visual do Badge (Reutilizável)
  const trendBadge = (
          ...
          {csPrice && (
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '6px', background: 'rgba(234, 179, 8, 0.1)', borderRadius: '6px', border: csPrice === bestPrice ? '1px solid #eab308' : '1px solid transparent' }}>
              <div style={{display: 'flex', alignItems: 'center', gap: '6px'}}>
                <span style={{ 
                  color: 'white', 
                  padding: '4px', // Ajustei levemente o padding
                  borderRadius: '4px', 
                  minWidth: '22px', 
                  height: '22px',
                  display: 'flex', 
                  ...
                  <svg id="svg" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0, 0, 400,400">
                    <g id="svgg">
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '6px', background: 'rgba(59, 130, 246, 0.1)', borderRadius: '6px', border: stPrice === bestPrice ? '1px solid #3b82f6' : '1px solid transparent' }}>
              <div style={{display: 'flex', alignItems: 'center', gap: '6px'}}>
                <span style={{ 
                  ...
                  borderRadius: '4px', 
                  minWidth: '22px', 
                  height: '22px', // Altura fixa para ficar quadrado/centralizado
                  display: 'flex', 
                  alignItems: 'center', 
                  justifyContent: 'center'
                }}>
